...
from packagefiles.editVideo import auto_game_montage
...
dropdown_games = ["Fortnite", "MW3 gun-game", "MW3 kill-confirmed", "MW3 free-for-all", "Warzone 2.0+", "Apex Legends",
                  "Rocket League", "CSGO", "Valorant", "Overwatch",
